...
1) 沙盒包目录（外部）：
- Android/data/io.github.black0bag.minibile/files/packages
2) 内置包：
...
6. Practical tip: download an existing skill, extract it directly, and ensure the directory contains SKILL.md`;
    ...
    const SANDBOX_EXTERNAL_PACKAGES_DIR = "/sdcard/Android/data/io.github.black0bag.minibile/files/packages";
    const TOOLPKG_DEBUG_INSTALL_ACTION = "io.github.black0bag.minibile.DEBUG_INSTALL_TOOLPKG";
    const TOOLPKG_DEBUG_INSTALL_COMPONENT = "io.github.black0bag.minibile/com.ai.assistance.operit.core.tools.packTool.ToolPkgDebugInstallReceiver";
    const SANDBOX_SCRIPT_EXECUTION_ACTION = "io.github.black0bag.minibile.EXECUTE_JS";
    const SANDBOX_SCRIPT_EXECUTION_COMPONENT = "io.github.black0bag.minibile/com.ai.assistance.operit.core.tools.javascript.ScriptExecutionReceiver";
    const SANDBOX_SCRIPT_EXECUTION_MODE_SCRIPT = "script";
    const SANDBOX_SCRIPT_EXECUTION_MODE_CODE = "code";
    const SANDBOX_JS_TEMP_DIR = "/sdcard/Android/data/io.github.black0bag.minibile/files/js_temp";
