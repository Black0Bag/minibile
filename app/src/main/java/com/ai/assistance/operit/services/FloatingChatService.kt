...
class FloatingChatService : Service(), FloatingWindowCallback {
    ...
    companion object {
        ...
        const val ACTION_FLOATING_CHAT_SERVICE_STARTED = "io.github.black0bag.minibile.action.FLOATING_CHAT_SERVICE_STARTED"
        const val ACTION_FLOATING_CHAT_SERVICE_STOPPED = "io.github.black0bag.minibile.action.FLOATING_CHAT_SERVICE_STOPPED"
        const val ACTION_FLOATING_CHAT_WINDOW_SHOWN = "io.github.black0bag.minibile.action.FLOATING_CHAT_WINDOW_SHOWN"
        const val ACTION_FLOATING_CHAT_WINDOW_SHOW_FAILED = "io.github.black0bag.minibile.action.FLOATING_CHAT_WINDOW_SHOW_FAILED"
